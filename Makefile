...
hashes := bbs city fast ign iqint1 iqint2 iqint2.x iqint2.y iqint2.z iqint3 \
	jkiss32 lcg murmur3 pg3d pcg3d.x pcg3d.y pcg3d.z pseudo ranlim32 sca08 superfast \
    tea2 tea2.x tea2.y tea3 tea3.x tea3.y tea4 tea4.x tea4.y tea5 tea5.x tea5.y tea6 tea6.x tea6.y \
	trig wang xorshift32 xxhash32
